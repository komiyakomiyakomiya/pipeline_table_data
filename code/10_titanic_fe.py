...
class sex_label_encoder(Feature):
    def create_features(self):
        cols = 'Sex'
        tmp_df = pd.concat([train, test], axis=0,
...
class age_mis_val_median(Feature):
    def create_features(self):
        self.train['Age_mis_val_median'] = train['Age'].fillna(
            train['Age'].median())
        self.test['Age_mis_val_median'] = test['Age'].fillna(
            test['Age'].median())
...
class fare_mis_val_median(Feature):
    def create_features(self):
        self.train['Fare_mis_val_median'] = train['Fare'].fillna(
            train['Fare'].median())
        self.test['Fare_mis_val_median'] = test['Fare'].fillna(
            test['Fare'].median())
